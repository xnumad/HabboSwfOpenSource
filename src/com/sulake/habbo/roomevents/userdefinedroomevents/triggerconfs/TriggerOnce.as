package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
    ...
    public class TriggerOnce extends WiredTrigger 
    {
        private var _roomEvents:HabboUserDefinedRoomEvents;
        private var _slider:SliderWindowController;


        public static function _Str_11919(k:int):String
        {
            var _local_2:int = Math.floor((k / 2));
            if ((k % 2) == 0)
            {
                return "" + _local_2;
            }
        ...
        override public function onInit(k:IWindowContainer, _arg_2:HabboUserDefinedRoomEvents):void
        {
            ...
            this._slider = new SliderWindowController(_arg_2, this.getInput(k), _arg_2.assets, 1, 1200, 1);
