...
{
    public class _Str_5099 extends RoomWidgetUpdateEvent 
    {
        ...
        public function _Str_5099(k:String, _arg_2:Number, _arg_3:String, _arg_4:String, _arg_5:String, _arg_6:int, _arg_7:Boolean=false, _arg_8:Boolean=false)
        {
