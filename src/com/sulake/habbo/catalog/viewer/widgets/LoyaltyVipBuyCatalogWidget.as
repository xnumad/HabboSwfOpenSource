package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class LoyaltyVipBuyCatalogWidget extends CatalogWidget implements IVipBuyCatalogWidget 
    {
        private var _controller:ClubOfferHandler;
        private var _offers:Array;
        private var _catalog:HabboCatalog;

        public function LoyaltyVipBuyCatalogWidget(k:IWindowContainer, _arg_2:HabboCatalog)
        {
            super(k);
        ...
        public function _Str_6059(offer:ClubBuyOfferData):void
        {
            ...
            try
            {
                item = new ClubOffer(offer, this._catalog, "HabboCatalogBuy");
            }
            catch(e:Error)
            {
