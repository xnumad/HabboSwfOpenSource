package com.sulake.habbo.moderation
{
    ...
    public class OpenIssuesView implements IIssueBrowserView 
    {
        ...
        public function OpenIssuesView(k:IssueManager, _arg_2:IssueBrowser, _arg_3:IWindowContainer)
        {
        ...
        {
            var k:Array = this._issueManager._Str_15829(IssueManager.ISSUE_BUNDLE_OPEN);
