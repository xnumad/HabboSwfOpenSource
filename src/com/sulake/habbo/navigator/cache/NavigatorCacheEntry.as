package com.sulake.habbo.navigator.cache
{
    ...
    public class NavigatorCacheEntry 
    {
        ...
        public function NavigatorCacheEntry(k:String, _arg_2:SearchResultContainer, _arg_3:Number, _arg_4:Number)
        {
            this._key = k;
        ...
        public function get _Str_23130():SearchResultContainer
        {
