package com.sulake.habbo.phonenumber
{
    ...
    public class VerificationCodeInputMinimizedView 
    {
        ...
        public function VerificationCodeInputMinimizedView(k:HabboPhoneNumber)
        {
            this._component = k;
            this.createWindow();
        }
        ...
        private function createWindow():void
        {
            ...
            this._window = this._component.windowManager.buildFromXML(XML(this._component.assets.getAssetByName("phonenumber_verify_minimized_xml").content));
        ...
        {
            this._component._Str_16951(false);
        }
