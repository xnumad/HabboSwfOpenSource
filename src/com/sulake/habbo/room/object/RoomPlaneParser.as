package com.sulake.habbo.room.object
{
    ...
    {
        private static const _Str_6100:Number = 0.25;
        private static const _Str_6429:Number = 0.25;
        private static const _Str_13826:Number = 20;
        public static const _Str_3134:int = -110;
        public static const _Str_5500:int = -100;
        ...
        private static function _Str_14393(k:Array):Number
        {
            var _local_8:int;
            var _local_2:int;
            var _local_3:int;
        ...
        private static function _Str_19173(k:Array):Point
        {
            if (k == null)
            {
                return null;
        ...
        private static function _Str_21256(k:Vector.<Vector.<int>>):Vector.<Vector.<int>>
        {
            var _local_2:uint;
            var _local_5:int;
            var _local_6:int;
        ...
        private static function _Str_19834(k:Vector.<Vector.<int>>):void
        {
            var _local_4:int;
            var _local_5:int;
            var _local_6:int;
        ...
        private static function _Str_20168(k:Vector.<Vector.<int>>):void
        {
        ...
        private static function _Str_20749(k:Vector.<Vector.<int>>):void
        {
            ...
            {
                _local_4.push(_Str_3134);
                _local_4.unshift(_Str_3134);
            }
            for each (_local_5 in k[0])
            {
                _local_2.push(_Str_3134);
                _local_3.push(_Str_3134);
            }
            k.push(_local_3);
            k.unshift(_local_2);
        }
        ...
        public function get _Str_23886():int
        {
            return this._width;
        }

        public function get _Str_25092():int
        {
            return this._height;
        }
        ...
        public function get _Str_7678():Number
        {
        ...
        public function _Str_13735(k:int, _arg_2:int):Boolean
        {
            var _local_4:Array;
            var _local_5:Array;
            var _local_6:Array;
            ...
            while (_local_3 < _arg_2)
            {
                ...
                while (_local_7 < k)
                {
                    _local_4[_local_7] = _Str_3134;
                    _local_5[_local_7] = _Str_3134;
        ...
        private function _Str_25886(k:int, _arg_2:int):Number
        {
            if (((((k < 0) || (k >= this._width)) || (_arg_2 < 0)) || (_arg_2 >= this._height)))
            {
                return _Str_3134;
        ...
        private function _Str_4480(k:int, _arg_2:int):Number
        {
            if (((((k < 0) || (k >= this._width)) || (_arg_2 < 0)) || (_arg_2 >= this._height)))
            {
                return _Str_3134;
        ...
        public function _Str_12919(k:int=-1):Boolean
        {
            var _local_2:int;
            var _local_3:int;
            ...
            var _local_4:Point = _Str_19173(this._tileMatrix);
            _local_3 = 0;
            while (_local_3 < this._height)
            {
                _local_2 = 0;
                while (_local_2 < this._width)
                {
                    ...
                    {
                        this._Str_3982(_local_2, _local_3, _Str_5500);
                    }
                    _local_2++;
                }
                _local_3++;
        ...
        private function initialize(k:Point):Boolean
        {
            ...
            if (k != null)
            {
                ...
                this._Str_3982(k.x, k.y, _Str_3134);
            }
            this._floorHeight = _Str_14393(this._tileMatrix);
            this._Str_23133();
        ...
        private function _Str_19326(k:Point, _arg_2:Boolean):RoomWallData
        {
            ...
            var _local_4:Array = [this._Str_24038, this._Str_24221, this._Str_25705, this._Str_22333];
            var _local_5:int;
        ...
        private function _Str_25300(k:RoomWallData):void
        {
            var _local_4:int;
            var _local_5:int;
            var _local_6:int;
        ...
        private function _Str_25293(k:RoomWallData):void
        {
            var _local_4:Point;
            var _local_5:int;
            var _local_6:int;
            ...
            while (_local_3 < _local_2)
            {
                if (!k._Str_10019(_local_3))
                {
                    ...
                    {
                        if (this._Str_4480(((_local_4.x + (_local_10 * _local_7.x)) - _local_8.x), ((_local_4.y + (_local_10 * _local_7.y)) - _local_8.y)) == _Str_5500)
                        {
        ...
        private function _Str_20164(k:Point, _arg_2:Point, _arg_3:RoomWallData):int
        {
            var _local_10:Point;
            var _local_11:Point;
            var _local_12:int;
        ...
        private function _Str_24096(k:RoomWallData, _arg_2:RoomWallData):void
        {
            var _local_5:Point;
            var _local_6:Point;
            var _local_7:IVector3D;
        ...
        private function _Str_25611(k:RoomWallData, _arg_2:RoomWallData):void
        {
        ...
        private function _Str_24673(k:RoomWallData, _arg_2:RoomWallData):void
        {
            var _local_5:int;
            var _local_6:int;
            var _local_8:Point;
        ...
        private function _Str_23133():Boolean
        {
            var _local_13:int;
            var _local_14:int;
            ...
            var _local_7:Number = Math.min(_Str_13826, ((this._fixedWallHeight != -1) ? this._fixedWallHeight : _Str_14393(k)));
            var _local_8:int = this.minX;
            var _local_9:int = this.minY;
            _local_9 = this.minY;
            while (_local_9 <= this.maxY)
            {
                if (this._Str_4480(_local_8, _local_9) > _Str_5500)
                {
                    _local_9--;
                    break;
                }
        ...
        private function _Str_24038(k:Point, _arg_2:Boolean):Point
        {
            if (k == null)
            {
                return null;
        ...
        private function _Str_24221(k:Point, _arg_2:Boolean):Point
        {
            if (k == null)
            {
                return null;
        ...
        private function _Str_25705(k:Point, _arg_2:Boolean):Point
        {
            if (k == null)
            {
                return null;
        ...
        private function _Str_22333(k:Point, _arg_2:Boolean):Point
        {
            if (k == null)
            {
                return null;
        ...
        private function _Str_22077(k:IVector3D, _arg_2:IVector3D, _arg_3:IVector3D, _arg_4:Boolean, _arg_5:Boolean, _arg_6:Boolean, _arg_7:Boolean):void
        {
            var _local_9:Number;
        ...
        public function _Str_16659(k:XML):Boolean
        {
            var _local_8:XML;
        ...
        public function _Str_20362(k:int):IVector3D
        {
        ...
        public function _Str_26428(k:int):IVector3D
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return null;
        ...
        public function _Str_16904(k:int):IVector3D
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return null;
        ...
        public function _Str_18119(k:int):IVector3D
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return null;
        ...
        public function _Str_23741(k:int):IVector3D
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return null;
        ...
        public function _Str_24698(k:int):Array
        {
            var _local_3:Array;
            var _local_4:int;
            if (((k < 0) || (k >= this._Str_3828)))
        ...
        public function _Str_13037(k:int):int
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
        ...
        public function _Str_25447(k:int):int
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return 0;
        ...
        public function _Str_23769(k:int, _arg_2:int):Number
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return -1;
        ...
        public function _Str_23247(k:int, _arg_2:int):Number
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return -1;
        ...
        public function _Str_23431(k:int, _arg_2:int):Number
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return -1;
        ...
        public function _Str_22914(k:int, _arg_2:int):Number
        {
            if (((k < 0) || (k >= this._Str_3828)))
            {
                return -1;
        ...
        public function _Str_12390(k:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int):void
        {
            this._Str_11339(k);
        ...
        public function _Str_11339(k:int):void
        {
            this._floorHoles.remove(k);
        }

        public function _Str_25334():void
        {
            this._floorHoles.reset();
        }

        private function _Str_25711():void
        {
            var k:int;
            var _local_2:int;
            var _local_3:Array;
        ...
        private function _Str_25564(k:Vector.<Vector.<int>>):void
        {
            var _local_2:uint;
            var _local_7:int;
            var _local_8:int;
