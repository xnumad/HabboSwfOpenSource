package com.sulake.habbo.ui.widget.furniture.trophy
{
    ...
    public class AchievementResolutionTrophyFurniWidget extends ConversionTrackingWidget implements ITrophyFurniWidget 
    {
        ...
        public function AchievementResolutionTrophyFurniWidget(k:IRoomWidgetHandler, _arg_2:IHabboWindowManager, _arg_3:IAssetLibrary, _arg_4:IHabboLocalizationManager, _arg_5:IHabboConfigurationManager)
        {
        ...
        override public function registerUpdateEvents(k:IEventDispatcher):void
        {
            ...
            k.addEventListener(_Str_5117.RWARTDUE_TROPHY_DATA, this.onObjectUpdate);
        ...
        override public function unregisterUpdateEvents(k:IEventDispatcher):void
        {
            ...
            k.removeEventListener(_Str_5117.RWARTDUE_TROPHY_DATA, this.onObjectUpdate);
        }

        private function onObjectUpdate(k:_Str_5117):void
        {
            this._name = k.name;
            this._date = k.date;
