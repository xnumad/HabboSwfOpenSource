package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
    ...
    public class PlaneTexture 
    {
        ...
        public function _Str_16790(k:BitmapData, _arg_2:Number=-1, _arg_3:Number=1, _arg_4:Number=-1, _arg_5:Number=1, _arg_6:String=null):void
        {
            var _local_7:PlaneTextureBitmap = new PlaneTextureBitmap(k, _arg_2, _arg_3, _arg_4, _arg_5, _arg_6);
            this._bitmaps.push(_local_7);
        }

        public function _Str_4913(k:IVector3D):BitmapData
        {
