            ...
            else
            {
                if (_local_2._Str_18882)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (((((_local_2.data._Str_2738 == RoomSettingsData.DOORMODE_NOOBS_ONLY) && (!(this._navigator._Str_2627.isAmbassador))) && (!(this._navigator._Str_2627.isRealNoob))) && (!(this._navigator._Str_2627.isGodMode))))
                            {
                                return;
                            }
