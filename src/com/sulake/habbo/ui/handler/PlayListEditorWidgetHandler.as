            ...
            switch (k.type)
            {
                case RoomWidgetFurniToWidgetMessage.RWFWM_MESSAGE_REQUEST_PLAYLIST_EDITOR:
                    ...
                    if (_local_3 != null)
                    {
                        ...
                        _local_8 = (((this._container.roomSession.isRoomController) || (this._container.roomSession.roomControllerLevel >= RoomControllerLevel.GUEST)) || (this._container.sessionDataManager._Str_2799));
                        if (_local_7)
                        {
