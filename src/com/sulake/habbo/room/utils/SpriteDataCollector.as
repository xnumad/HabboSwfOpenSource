package com.sulake.habbo.room.utils
{
    ...
    public class SpriteDataCollector 
    {
        ...
        private static function _Str_22230(k:Vector.<RoomObjectSpriteData>, _arg_2:RoomEngine):Vector.<RoomObjectSpriteData>
        {
            ...
            {
                if (((_local_4._Str_1723 == "boutique_mannequin1") && (_local_4.name.indexOf("mannequin_") == 0)))
                {
        ...
        public function _Str_4536(k:Rectangle, _arg_2:IRoomRenderingCanvas, _arg_3:RoomEngine, _arg_4:int):String
        {
            ...
            var _local_7:Array = _arg_3._Str_21072(_arg_3.activeRoomId, RoomObjectCategoryEnum.CONST_100);
            for each (_local_8 in _local_7)
            {
                if (_local_8.getId() != _arg_4)
                {
                    ...
                    if (_local_11)
                    {
                        ...
                        _local_15 = _arg_3._Str_6960(_arg_3.activeRoomId, _local_8.getId(), RoomObjectCategoryEnum.CONST_100, _arg_2.getId());
                        if (_local_15)
                        {
                            if (_local_13 == 0)
                            {
        ...
        private function _Str_25623(k:Vector.<IRoomPlane>, _arg_2:IRoomRenderingCanvas, _arg_3:RoomEngine):Array
        {
            ...
            for each (_local_9 in _local_7)
            {
                ...
                if (_local_11 != null)
                {
                    _local_10 = _local_4.remove(_local_11._Str_9396);
                    if (_local_10 != null)
                    {
