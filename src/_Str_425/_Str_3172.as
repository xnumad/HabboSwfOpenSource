package _Str_425
{
    ...
    public class _Str_3172 
    {
        ...
        public function _Str_3172(k:IRoomEngine, _arg_2:int=1)
        {
            this._Str_9748 = new Point(0, 0);
            super();
            this._roomEngine = k;
            this._Str_2733 = RoomId._Str_24114(_arg_2);
            if (this._Str_2949)
            {
        ...
        public function _Str_3478(k:int, _arg_2:int):DisplayObject
        {
            ...
            if (this._Str_2949)
            {
                ...
                if (_local_4 != null)
                {
                    _local_4._Str_9651(new Vector3d(_Str_7483, _Str_7468, 0), 30);
                }
                this._Str_8626 = k;
            ...
            if (this._Str_2949)
            {
                ...
                else
                {
                    if ((((this._Str_2705.width << 1) < ((this._Str_8626 * (1 + _Str_8975)) - 5)) && ((this._Str_2705.height << 1) < ((this._Str_7356 * (1 + _Str_8975)) - 5))))
                    {
                        ...
                        {
                            if (((!(_local_2._Str_8719())) && (!(this._Str_11693))))
                            {
                                _local_2._Str_17302();
                                this._Str_5883 = _Str_6747;
                                k.x = (k.x << 1);
