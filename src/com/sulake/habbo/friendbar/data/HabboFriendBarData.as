    ...
    public class HabboFriendBarData extends Component implements IHabboFriendBarData 
    {
        ...
        private function _Str_4132(k:IMessageEvent):void
        {
            ...
            for each (_local_4 in _local_6)
            {
                ...
                else
                {
                    if (((_local_4.online) || (_Str_6664)))
                    {
                        _local_3 = new FriendEntity(_local_4.id, _local_4.name, _local_4.realName, _local_4.motto, _local_4.gender, _local_4.online, _local_4.followingAllowed, _local_4.figure, _local_4.categoryId, _local_4._Str_5261);
        ...
        private function _Str_25150(k:Array):void
        {
            ...
            for each (_local_2 in k)
            {
                ...
                {
                    _local_3 = new FriendEntity(_local_2.id, _local_2.name, _local_2.realName, _local_2.motto, _local_2.gender, _local_2.online, _local_2.followingAllowed, _local_2.figure, _local_2.categoryId, _local_2._Str_5261);
                    this._friendEntityList.push(_local_3);
                    this._friendMappedByID.add(_local_3.id, _local_3);
                }
            }
