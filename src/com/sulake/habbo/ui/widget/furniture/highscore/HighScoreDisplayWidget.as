package com.sulake.habbo.ui.widget.furniture.highscore
{
    ...
    public class HighScoreDisplayWidget extends RoomWidgetBase
    {
        ...
        public function open(k:int, _arg_2:int, _arg_3:HighScoreStuffData):void
        {
            ...
            {
                _local_6 = HighScoreFurniWidgetHandler(_handler).container.localization.getLocalization(("high.score.display.cleartype." + _Str_18147[_arg_3.clearType]));
                _local_7 = HighScoreFurniWidgetHandler(_handler).container.localization.getLocalization(("high.score.display.scoretype." + _Str_18189[_arg_3.scoreType]));
                HighScoreFurniWidgetHandler(_handler).container.localization.registerParameter("high.score.display.caption", "cleartype", _local_6);
                HighScoreFurniWidgetHandler(_handler).container.localization.registerParameter("high.score.display.caption", "scoretype", _local_7);
            }
            this._roomId = _arg_2;
            this._roomObjId = k;
            this.createWindow();
