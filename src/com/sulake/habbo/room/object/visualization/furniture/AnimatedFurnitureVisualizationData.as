package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class AnimatedFurnitureVisualizationData extends FurnitureVisualizationData 
    {
        ...
        {
            var _local_3:AnimationSizeData = (_Str_2735(k) as AnimationSizeData);
            if (_local_3 != null)
            {
        ...
        {
            var _local_2:AnimationSizeData = (_Str_2735(k) as AnimationSizeData);
            if (_local_2 != null)
            {
        ...
        {
            var _local_4:AnimationSizeData = (_Str_2735(k) as AnimationSizeData);
            if (_local_4 != null)
            {
        ...
        {
            var _local_6:AnimationSizeData = (_Str_2735(k) as AnimationSizeData);
            if (_local_6 != null)
            {
        ...
        {
            var _local_8:AnimationSizeData = (_Str_2735(k) as AnimationSizeData);
            if (_local_8 != null)
            {
