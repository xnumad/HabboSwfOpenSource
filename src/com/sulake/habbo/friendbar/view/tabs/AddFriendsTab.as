package com.sulake.habbo.friendbar.view.tabs
{
    ...
    public class AddFriendsTab extends Tab 
    {
        ...
        {
            var k:AddFriendsTab = ((_Str_2469.length > 0) ? _Str_2469.pop() : new (AddFriendsTab)());
            k._Str_2638 = false;
        ...
        override public function select(k:Boolean):void
        {
            if (!selected)
            {
                ...
                {
                    Motions._Str_4598(new Combo(new EaseOut(new ResizeTo(window, _Str_6722, window.width, _Str_6265), _Str_6252), new EaseOut(new MoveBy(window, _Str_6722, window.x, -(_Str_6265 - _Str_2790)), _Str_6252)));
                }
                else
                {
                    window.height = _Str_6265;
                    window.y = (window.y - (window.height - _Str_2790));
                }
